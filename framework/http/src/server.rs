...
impl HttpServer {
    pub async fn start(self) -> CellResult<()> {
        ...
        server
            .await
            .map_err(|e| CellError::from(ErrorEnumsStruct::UNKNOWN).with_error(Box::new(e)));
...
pub async fn async_hyper_service_fn(
    mut server: Arc<HttpServer>,
    req: Request<Body>,
